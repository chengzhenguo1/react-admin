...
export const PASSWORDREG = /^[a-zA-Z]\w{5,17}$/
...
export const ConfirmPassWord = ({ getFieldValue }: any) => ({
...
/* 确认密码 */
export const ConfirmRule: Rule[] = [{ required: true, message: '请输入重复密码！' }, ConfirmPassWord]
